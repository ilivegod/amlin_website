...
export default function Home() {
  return (
    <div className="flex min-h-screen w-full flex-col">
      ...
      >
        <div className="mx-auto flex min-h-screen w-full max-w-[42rem] flex-col px-[var(--hero-gutter)] pb-[6.5rem] pt-[calc(var(--nav-h)+4.75rem)] md:max-w-none md:px-[var(--hero-gutter)]">
          <div className="flex flex-1 flex-col justify-center md:max-w-[42rem]">
            <p
              className="amlin-fade mb-7 font-inter text-[0.6875rem] font-normal uppercase tracking-[0.2em] text-white/[0.42]"
            ...
            <h1 className="font-polysans text-[clamp(2.75rem,7.4vw,6.5rem)] font-extrabold leading-[0.94] tracking-[-0.035em] text-white">
            ...
            <p
              className="amlin-fade mt-8 max-w-[30rem] font-inter text-[clamp(0.9375rem,1.15vw,1.0625rem)] font-normal leading-[1.6] text-white/[0.66] md:mt-8"
            ...
            <div
              className="amlin-fade mt-10 flex flex-col items-start gap-7 sm:flex-row sm:items-center md:mt-10"
          ...
          <div className="mt-auto pt-10 md:absolute md:bottom-7 md:left-[var(--hero-gutter)] md:pt-0">
            <IndustriesStrip delay="1.8s" />
          </div>
        </div>
      </HeroParallax>
