...
export default function Home() {
  return (
    <div className="flex min-h-screen w-full flex-col">
      ...
      >
        <div className="mx-auto flex h-full w-full flex-col px-[var(--hero-gutter)] pb-10 pt-[var(--nav-h)]">
          <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center text-center">
            <p
              className="amlin-fade mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 font-inter text-[0.6875rem] font-normal uppercase tracking-[0.18em] text-white/[0.6]"
